...
const categories = [
  {
    icon: Heart,
    title: "Medical",
    description: "Support healthcare initiatives, medical treatments, and emergency medical aid across Sri Lanka",
    count: 247,
  ...
  },
  {
    icon: GraduationCap,
    title: "Education",
    description: "Fund schools, scholarships, educational resources, and learning opportunities for all",
    count: 189,
  ...
  },
  {
    icon: Laptop,
    title: "Technology",
    description: "Digital literacy, tech training, and innovation projects to bridge the digital divide",
    count: 94,
  ...
  },
  {
    icon: Users,
    title: "Community",
    description: "Local community development, infrastructure, and social welfare initiatives",
    count: 156,
  ...
  },
  {
    ...
    description: "Emergency response, flood relief, and disaster recovery support for affected areas",
    count: 73,
  ...
  },
  {
    icon: PawPrint,
    title: "Animals",
    description: "Wildlife conservation, animal rescue, veterinary care, and habitat protection",
    count: 42,
  ...
  },
  {
    icon: Palette,
    title: "Arts & Culture",
    description: "Preserve Sri Lankan heritage, support artists, and promote cultural activities",
    count: 67,
  ...
  },
  {
    icon: Trophy,
    title: "Sports",
    description: "Athletic programs, sports facilities, equipment, and youth sports development",
    count: 38,
